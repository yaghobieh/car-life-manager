...
import { COLOR_BLUE, COLOR_INK, COLOR_MUTED_2, COLOR_WHITE, FLEX_GAP_SM, LOGO_PRODUCT_PLATFORM, SVG_LOGO_MARK, SVG_LOGO_SIZE } from '@const';
import { SvgAsset } from '@components/SvgAsset';
import { LOGO_WORD } from './Logo.const';
