...
import { smsActionHref, smsActionLabelKey, smsHelpKey } from '../../Settings/Settings.utils';
  ...
  return (
    <div className="Bear-PropertySettings">
      ...
      <ClmList>
        ...
        <ClmRow
          title={t('emailAlerts')}
          subtitle={emailNotifyReady ? t('propertyEmailReady') : t('propertyEmailMissing')}
          action={(
      ...
      {emailNotifyReady ? null : (
        <OfficialLink href={RESEND_SIGNUP_URL} label={t('resendSignupCta')} />
      )}
